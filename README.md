...
整数０から1000000までの値の持つ、約数をエラトステネスの篩を使って調べ上げて＊で表示する。
...
⚠️ **重要**: このバージョンは教育・研究目的の実装です。整数 1000000 までの約数を扱うため、現代の暗号システム（RSA-4096など）には影響しません。
